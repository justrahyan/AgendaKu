...
public class JButtonRoundedKembali extends JButton {
    ...
    public JButtonRoundedKembali() {
        fillOriginal = new Color(252,102,2);
        fillOver = new Color(250,135,58);
        fillClick = new Color(228,95,6);
        strokeWidth = 2;
        roundedCorner = 10;
        fill = fillOriginal;
        icon = null;
