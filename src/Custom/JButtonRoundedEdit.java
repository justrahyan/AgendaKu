...
public class JButtonRoundedEdit extends JButton {
    ...
    public JButtonRoundedEdit() {
        fillOriginal = new Color(18,202,110);
        fillOver = new Color(49,231,140);
        fillClick = new Color(26,164,95);
        strokeWidth = 2;
        roundedCorner = 10;
        fill = fillOriginal;
        icon = null;
