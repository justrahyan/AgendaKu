...
public class JButtonRoundedTambah extends JButton {
    ...
    public JButtonRoundedTambah() {
        fillOriginal = new Color(51,150,217);
        fillOver = new Color(81,175,239);
        fillClick = new Color(42,131,192);
        strokeWidth = 2;
        roundedCorner = 10;
        fill = fillOriginal;
        icon = null;
