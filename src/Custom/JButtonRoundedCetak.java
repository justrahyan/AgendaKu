...
public class JButtonRoundedCetak extends JButton {
    ...
    public JButtonRoundedCetak() {
        fillOriginal = new Color(254,200,104);
        fillOver = new Color(246,202,123);
        fillClick = new Color(218,167,75);
        strokeWidth = 2;
        roundedCorner = 10;
        fill = fillOriginal;
        icon = null;
