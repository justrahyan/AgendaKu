...
public class JButtonRoundedHapus extends JButton {
    ...
    public JButtonRoundedHapus() {
        fillOriginal = new Color(255,1,55);
        fillOver = new Color(255,93,127);
        fillClick = new Color(185,16,52);
        strokeWidth = 2;
        roundedCorner = 10;
        fill = fillOriginal;
        icon = null;
